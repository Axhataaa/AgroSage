...
const CROPS = [
  ...
  {name:'Cotton',emoji:'🌸',season:'kharif',type:'fibre',bg:'#E3F2FD',
   ...
   altSeason:'Kharif',altSeasonIcon:'🌧️',altSeasonDesc:'Sown April–May, harvested October–November'},
  ...
  {name:'Watermelon',emoji:'🍉',season:'zaid',type:'fruit',bg:'#FCE4EC',
   ...
   altSeason:'Zaid',altSeasonIcon:'☀️',altSeasonDesc:'Sown February–March, harvested May–June'},
